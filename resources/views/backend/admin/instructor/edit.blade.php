                        ...
                        <div class="tab-content" id="pills-tabContent">
                            <div class="tab-pane fade show active" id="basicInfo" role="tabpanel"
                                ...
                                <div class="row gx-20">
                                    ...
                                    <div class="col-lg-4">
                                        <div class="price-checkbox d-flex gap-12 mb-2">
                                            ...
                                            <div class="setting-check">
                                                <input name="permissions[can_edit_profile]" type="checkbox" id="checkbox1"  value="1" {{ is_array($user->permissions) && in_array('can_edit_profile', $user->permissions) ? 'checked' : '' }}>
                                                <label for="checkbox1"></label>
                                            </div>
                                        </div>
                                        <div class="price-checkbox d-flex gap-12 mb-4">
                                            <label for="checkbox2">{{ __('media_library') }}</label>
                                            <div class="setting-check">
                                                <input name="permissions[can_edit_media_library]" type="checkbox" id="checkbox2"  value="1" {{ is_array($user->permissions) && in_array('can_edit_media_library', $user->permissions) ? 'checked' : '' }}>
                                    ...
                                    <div class="col-lg-4">
                                        <div class="price-checkbox d-flex gap-12 mb-2">
                                            <label for="checkbox3">{{ __('quiz_&_assignment') }}</label>
                                            <div class="setting-check">
                                                <input name="permissions[can_edit_quiz_&_assignment]" type="checkbox" id="checkbox3"  value="1" {{ is_array($user->permissions) && in_array('quiz_&_assignment', $user->permissions) ? 'checked' : '' }}>
                                                <label for="checkbox3"></label>
                                            </div>
                                        </div>
                                        <div class="price-checkbox d-flex gap-12 mb-2">
                                            <label for="checkbox4">{{ __('students') }}</label>
                                            <div class="setting-check">
                                                <input name="permissions[can_edit_students]" type="checkbox" id="checkbox4"  value="1" {{ is_array($user->permissions) && in_array('can_edit_students', $user->permissions) ? 'checked' : '' }}>
                                    ...
                                    <div class="col-lg-4">
                                        <div class="price-checkbox d-flex gap-12 mb-4">
                                            <label for="checkbox5">{{ __('course') }}</label>
                                            <div class="setting-check">
                                                <input name="permissions[can_edit_course]" type="checkbox" id="checkbox5"  value="1" {{ is_array($user->permissions) && in_array('can_edit_course', $user->permissions) ? 'checked' : '' }}>
                                                <label for="checkbox5"></label>
                                            </div>
                                        </div>
                                        <div class="price-checkbox d-flex gap-12 mb-4">
                                            <label for="checkbox6">{{ __('certificates') }}</label>
                                            <div class="setting-check">
                                                <input name="permissions[can_edit_certificates]" type="checkbox" id="checkbox6"  value="1" {{ is_array($user->permissions) && in_array('can_edit_certificates', $user->permissions) ? 'checked' : '' }}>
