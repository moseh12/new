...
@section('content')
    <section class="oftions">
        <div class="container-fluid">
            <div class="row">
                <div class="col-lg-12">
                    <h3 class="section-title">{{__('edit_quiz')}}/{{__('quiz_details')}}</h3>
                    <div class="bg-white redious-border p-20 p-sm-30">
                        <form action="{{ route('quizzes.update',$quiz->id) }}" class="form" method="POST">@csrf
                            ...
                            <div class="row">
                                ...
                                <div class="col-lg-12">
                                    <h6 class="sub-title">{{__('quiz_questions')}}</h6>
                                    @foreach($quiz->questions as $qu)
                                        <div class="list-view py-12 ps-2 pe-3 pe-sm-30 mb-20">
                                            ...
                                            <ul class="d-flex align-items-center gap-20">
                                                <li>
                                                    <a href="#" class="icon edit_modal"
                                                       data-total_answers="{{ $qu->answers ? count($qu->answers) : 0 }}"
                                                       data-fetch_url="{{ route('quiz-questions.edit', $qu->id) }}"
                                                       data-route="{{ route('quiz-questions.update', $qu->id) }}"
                                                       data-modal="editQuiz">
                                                ...
                                                <li><a class="icon" data-bs-placement="top"
                                                       ...
                                                       onclick="delete_row('{{ route('quiz-questions.destroy', $qu->id) }}',null,true)"
    ...
    <div class="modal fade" id="addQuiz" tabindex="-1" aria-labelledby="addQuizLabel" aria-hidden="true">
        <div class="modal-dialog modal-dialog-centered modal-xl">
            <div class="modal-content">
                <h6 class="sub-title">{{__('add_new_question')}}</h6>
                ...
                <form action="{{ route('quiz-questions.store') }}" method="POST" class="form">@csrf
                    <div class="row gx-20">
                            ...
                            <div class="mb-4">
                                ...
                                <div class="select-type-v2">
                                    <select id="question_type" name="question_type"
                                        ...
                                        <option value="default" selected>{{__('default_question')}}</option>
                                        <option value="mcq">{{__('multiple_choice_question')}}</option>
                                    </select>
                                    <div class="nk-block-des text-danger">
                        ...
                        <div class="col-12 question_div mb-4">
                            <div class="">
                                ...
                                <div class="moveable-lit p-20 p-sm-30 default_question_div rounded-2 border">
                                    <div class="answer_area" id="answerAreaMoved">
                                        <div class="input-group mb-20">
                                            ...
                                            <div class="custom-radio d-flex align-items-center">
                                                <label>
                                                    <input type="radio" name="correct_answer" checked value="1">
                                                    <span class=""></span>
                                                </label>
                                            </div>
                                            <span class="input-group-text ansMove"><i
                                                    class="las la-arrows-alt"></i></span>
                                        </div>
                                        <!-- End Input Group -->
                                        ...
                                        <div class="input-group mb-20">
                                            ...
                                            <div class="custom-radio d-flex align-items-center">
                                                <label>
                                                    <input type="radio" name="correct_answer" checked value="3">
                                                    <span class=""></span>
                                                </label>
                                            </div>
                                            <span class="input-group-text ansMove"><i
                                        ...
                                        <div class="input-group mb-20">
                                            ...
                                            <div class="custom-radio d-flex align-items-center">
                                                <label>
                                                    <input type="radio" name="correct_answer" checked value="4">
                                                    <span class=""></span>
                                                </label>
                                            </div>
                                            <span class="input-group-text ansMove"><i
                                    ...
                                    <div class="d-flex justify-content-start align-items-center mt-30">
                                        <button type="button"
                                                class="btn sg-btn-outline-primary add_answer">{{__('add_answer')}}
                                        </button>
                                    </div>
                                </div>
                                <!-- End default section-->
                        ...
                        <div class="col-12">
                            <div class="mb-4">
                                ...
                                <textarea name="description" class="form-control rounded-2" id="description"
                    ...
                    <div class="d-flex justify-content-between align-items-center mt-30">
                        ...
                        <button type="submit" class="btn sg-btn-primary">{{__('add_question')}}</button>
                        @include('backend.common.loading-btn',['class' => 'btn sg-btn-primary'])
                    </div>
                </form>
            </div>
...
@push('js_asset')
    ...
    <script src="{{ static_asset('admin/js/tagify.js') }}"></script>
@endpush
@push('js')
    <script>
        $(document).ready(function () {
            ...
            $(document).on('change', '#question_type', function () {
                ...
                if (question_type == 'mcq') {
                    ...
                    $('.matching_div').addClass('d-none');
                    $('.drag_and_drop_div').addClass('d-none');
                    ...
                    $('.drag_and_drop_div').removeClass('d-none');
                    $('.default_question_div').addClass('d-none');
                    $('.matching_div').addClass('d-none');
                    $('.mcq_div').addClass('d-none');
                    ...
                    $('.matching_div').removeClass('d-none');
                    $('.default_question_div').addClass('d-none');
                    $('.drag_and_drop_div').addClass('d-none');
                    $('.mcq_div').addClass('d-none');
