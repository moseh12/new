            ...
            <div class="mb-4">
                <div class="mb-20">
                    ...
                    <input id="datePicker" type="text" name="deadline"
                           value="{{ \Carbon\Carbon::parse($assignment->deadline)->format('Y-m-d H:i:s') }}"
                ...
                <div class="multi-select-v2 mb-4">
                    ...
                    <select id="selectInstructor" name="instructor_id"
                        ...
                        @foreach($instructors as $instructor)
                            <option
                                value="{{ $instructor->id }}" {{ $assignment->instructor_id == $instructor->id ? 'selected' : '' }}>{{ $instructor->name }}</option>
                        @endforeach
                    </select>
                    <div class="nk-block-des text-danger">
            ...
            <div class="multi-select-v2 mb-4">
                ...
                <select id="section_id" name="section_id"
                    ...
                    @foreach($sections as $section)
                        <option
                            value="{{ $section->id }}" {{ $assignment->section_id == $section->id ? 'selected' : '' }}>{{ $section->title }}</option>
                    @endforeach
                </select>
                <div class="nk-block-des text-danger">
