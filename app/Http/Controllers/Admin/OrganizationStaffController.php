...
class OrganizationStaffController extends Controller
{
    ...
    public function index(StaffDataTable $dataTable, Request $request, $org_id)
    {
        ...
        try {
            ...
            return $dataTable->with('org_id', $org_id)->render('backend.admin.org_staff.index', $data);
        } catch (\Exception $e) {
    ...
    public function create(Request $request, $org_id, ExpertiseRepository $expertiseRepository, OrganizationRepository $orgRepo)
    {
        try {

            $data = [
                'organization'    => $orgRepo->find($org_id),
                'organization_id' => $org_id,
                'expertises'      => $expertiseRepository->activeExpertises(),
            ];

            return view('backend.admin.org_staff.create', $data);
        } catch (Exception $e) {
    ...
    public function store(InstructorRequest $request, $org_id, UserRepository $userRepository): \Illuminate\Http\JsonResponse
    {
        ...
        try {
            ...
            return response()->json([
                ...
                'route'   => route('organizations.staff.index', $org_id),
            ]);
        } catch (Exception $e) {
            DB::rollBack();
    ...
    public function edit(ExpertiseRepository $expertiseRepository, $org_id, $id): \Illuminate\Contracts\View\View|\Illuminate\Contracts\View\Factory|\Illuminate\Http\RedirectResponse|\Illuminate\Contracts\Foundation\Application
    {
        try {
            ...
            return view('backend.admin.org_staff.edit', $data);
        } catch (Exception $e) {
            Toastr::error($e->getMessage());
    ...
    public function update(InstructorRequest $request, $org_id, $id): \Illuminate\Http\JsonResponse
    {
        if (config('app.demo_mode')) {
            $data = [
                'status' => 'danger',
        ...
        try {
            ...
            return response()->json(['success' => __('update_successful'),  'route' => route('organizations.staff.index', $org_id)]);
        } catch (Exception $e) {
            DB::rollBack();
